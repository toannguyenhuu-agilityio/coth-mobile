...
export const ManageSubscriptionsScreen = () => {
  const { currentTier, loading, currentOffering, restorePurchases, getPackagesForTier } =
    useSubscriptionStore();

  const [selectedTier, setSelectedTier] = useState<'gold' | 'silver' | null>(null);
        ...
        <TouchableOpacity
          ...
          onPress={async () => {
            try {
              ...
              console.error(e);
              Alert.alert('Error', 'Failed to open Customer Center');
            }
          }}
        >
          <Text style={styles.manageText}>Open Customer Center</Text>
        </TouchableOpacity>
      </ScrollView>
