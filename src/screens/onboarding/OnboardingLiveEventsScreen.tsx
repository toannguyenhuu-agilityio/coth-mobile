...
export const OnboardingLiveEventsScreen = () => {
  const navigation = useNavigation();

  const handleNext = () => {
    navigation.navigate(ROUTES.ONBOARDING_GOSPEL_BOT as never);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.backgroundContainer}>
        <ImageBackground
          source={IMAGES.onboardingLiveShowBackground}
      ...
      <View style={styles.contentContainer}>
        ...
        >
          <View style={styles.textContainer}>
            <Text style={styles.title}>Free Live Show Access</Text>
            <Text style={styles.description}>
              Meet the community at Free Live Events near you! You're never isolated in Core of the
              Heart.
            </Text>
          </View>
