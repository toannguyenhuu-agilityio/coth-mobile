...
// Constants
import { ROUTES, IMAGES, SCREEN_WIDTH, SCREEN_HEIGHT } from '@/constants';

export const OnboardingSpiritualToolsScreen = () => {
  const navigation = useNavigation();

  const handleNext = () => {
    navigation.navigate(ROUTES.ONBOARDING_SPIRITUAL_UNLOCK as never);
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.backgroundContainer}>
        ...
        <View style={styles.imageContainer}>
          <ImageBackground
            source={IMAGES.onboardingSpiritualToolBackground}
      ...
      <View style={styles.contentContainer}>
        ...
        >
          <View style={styles.textContainer}>
            <Text style={styles.title}>Spiritual Tools</Text>
            <Text style={styles.description}>
              Use your spiritual tools like The Bible and your Journal to assist your daily walk
              with God.
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    lineHeight: typography.fontSize['5xl'] * 1.274,
    color: colors.white[100],
  },
